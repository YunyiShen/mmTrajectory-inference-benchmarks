...
class langevinlamboseen(nn.Module):
    ...
    def __init__(self, x0 = 0., y0 = 0., logscale = -2., circulation = 1., logsigma = np.log(0.02), logdrag = np.log(0.5), logtimescale = 0.):
...
class repressilator_mrnaprotein(nn.Module):

    def __init__(self, alpha = 1e-5, beta_m = 10., n = 3., k = 1., gamma_m = 1., beta_p = 1., gamma_p = 1., sigma = 0.02):
